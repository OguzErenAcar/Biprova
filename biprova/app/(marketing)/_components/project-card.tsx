...
export function ProjectCard({ city, status, title, roles }: ProjectCardProps) {
  ...
  return (
    <div className="bg-white border border-slate-200 rounded-[20px] p-[1.6rem] hover:-translate-y-0.5 hover:shadow-[0_10px_28px_rgba(37,99,235,0.1)] transition-all duration-200 cursor-pointer">
