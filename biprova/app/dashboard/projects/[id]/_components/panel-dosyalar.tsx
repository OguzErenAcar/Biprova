    ...
    <div id="panel-dosyalar">
      <Card className="overflow-hidden">
        <CardHeader className="px-[1.2rem] py-[1rem] border-b border-slate-200 flex-row items-center justify-between space-y-0">
          ...
          <Button variant="ghost" size="sm" className="text-[0.75rem] font-bold text-blue-600 h-auto py-0.5">
            + Ekle
          </Button>
        </CardHeader>
        <CardContent className="px-[1.2rem] py-[1rem]">
          <Button
            variant="outline"
            className="w-full border-dashed text-[0.82rem] font-bold text-slate-400 hover:border-blue-600 hover:text-blue-600 hover:bg-blue-50"
          >
