export function TimerWarning() {
  return (
    <div className="bg-amber-50 border-[1.5px] border-amber-200 rounded-xl px-5 py-[0.9rem] flex items-center gap-3 mb-6 text-[0.88rem] font-semibold text-amber-800">
