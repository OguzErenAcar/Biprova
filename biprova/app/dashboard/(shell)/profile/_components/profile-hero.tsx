  ...
  return (
    <div id="profile-hero" className="bg-white border border-slate-200 rounded-[16px] overflow-hidden mb-5">
      ...
      <div className="px-6 pb-6">
        ...
        <div className="flex items-end gap-4 -mt-[60px] mb-2">
          {/* Avatar */}
          <div className="w-[120px] h-[120px] shrink-0 rounded-full border-4 border-white shadow-[0_4px_16px_rgba(37,99,235,0.25)] overflow-hidden relative">
            {user.avatar_url ? (
              <img
                src={user.avatar_url}
                alt={user.name}
          ...
          {/* Name + Badges */}
          <div className="flex flex-1 items-center justify-between pb-1 min-w-0">
            <div className="font-nunito font-black text-[1.4rem] text-slate-900 truncate">
              {user.name}
            </div>
