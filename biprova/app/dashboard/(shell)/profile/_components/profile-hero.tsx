  ...
  return (
    <div id="profile-hero" className="bg-white border border-slate-200 rounded-[16px] overflow-hidden mb-5">
      ...
      <div className="px-6 pb-6 relative">
        ...
        {/* Badges + butonlar — sağ üst */}
        <div className="absolute top-2.5 right-6 flex items-center gap-2">
          {user.badge && (
        ...
        {/* Name */}
        <div className="font-nunito font-black text-[1.4rem] text-slate-900 pt-[62px] mb-2">
          {user.name}
        </div>
