  ...
  return (
    <div ref={containerRef} className="relative flex-1 min-w-0 max-w-[200px]">
      ...
      <input
        ...
        className="w-full bg-white border-[1.5px] border-slate-200 rounded-[10px] pl-9 pr-4 py-[0.6rem] font-jakarta text-body text-slate-900 outline-none focus:border-blue-600 placeholder:text-slate-400 transition-colors duration-200"
      />
