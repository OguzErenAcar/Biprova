...
export function HomeTopbar({ projects = [] }: { projects?: DrawerProject[] }) {
  ...
  return (
    <>
      <div id="dashboard-topbar" className="relative  md:my-5 g-topbar shadow-lg shadow-black/10 md:rounded-md mx-auto w-100 md:w-[90%] md:border border-black px-[12px] sm:px-6 lg:px-8 py-[0.9rem] flex items-center gap-4">
        <Link
          href="/dashboard"
