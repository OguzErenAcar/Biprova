  ...
  return (
    <div id="dashboard-topbar" className="sticky top-0 z-40 bg-slate-100/90 backdrop-blur-md border-b border-slate-200 px-4 sm:px-6 lg:px-8 py-[0.9rem] flex items-center gap-4">
      ...
      <div className="ml-auto flex items-center gap-[0.6rem]">
        {/* Mesajlar → aktif proje */}
        <Link
          href="/dashboard/activeProject"
          className="relative w-[38px] h-[38px] rounded-[10px] bg-white border-[1.5px] border-slate-200 flex items-center justify-center text-[1rem] cursor-pointer hover:border-blue-600 transition-colors duration-150"
        >
          💬
