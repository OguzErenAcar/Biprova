...
export function TabBar() {
  ...
  return (
    <nav id="dashboard-tab-bar" className="lg:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-edge z-[100] pt-[0.4rem] pb-[calc(0.4rem+env(safe-area-inset-bottom))]">
