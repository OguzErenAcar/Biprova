...
- Name: security-advanced.spec.ts >> Reflected XSS >> login?next= XSS payload HTML'de ham çıkmamalı: <img src=x onerror=alert(1)>
...
Expected substring: not "onerror=alert(1)"
